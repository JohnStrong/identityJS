...
;(function(module) {
	...
	_check = {
		...
		// Boolean, Null, Undefined, String, Date
		'Primitive': function(suspect, witness) {
		...
		'RegExp': function(suspect, witness) {
	...
	_identity = function(suspect, witness) {
		...
		if(arguments.length) {
			var expectedType = _check[_type(witness)] || _check.Primitive;
